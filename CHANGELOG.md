...
- README / docs 与当前代码同步：标准 TraceHook / 标准中间件接入方式更新；
- 清理过期规划文档与 adapters 历史表述。
...
- 导出家族统一链路契约 `TraceAttr` 与 `TraceHook`，供各基座以类型别名方式复用。

### 变更

- 依赖升级：errx v1.5.7、logx v1.3.4、testx v1.4.4 及三方最新版本（go get -u -t all）。
